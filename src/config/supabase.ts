...
const supabaseUrl = import.meta.env.VITE_SUPABASE_URL || 'https://irkfrlvddkyjziuvrisb.supabase.co'
const supabaseAnonKey = import.meta.env.VITE_SUPABASE_ANON_KEY || 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6Imlya2ZybHZkZGt5anppdXZyaXNiIiwicm9sZSI6ImFub24iLCJpYXQiOjE3NTEzNDk0NjgsImV4cCI6MjA2NjkyNTQ2OH0.5yUxCnz_kHlEMX7caL4dGsF22F6YKlVUDWUyIY6L_Cc'
